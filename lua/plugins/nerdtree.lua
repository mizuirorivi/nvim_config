...
--   nerdlog:onlysave('SetNERDTreeRootToNearestGit is called')
--   if vim.g.isopenednerdtree == 1 then
--     nerdlog:onlysave('NERDTree is already opened')
...
-- vim.api.nvim_set_keymap('n', '<C-i>', ':lua SetNERDTreeRootToNearestGit()<CR>', { noremap = true, silent = true })
-- -- adjust action
